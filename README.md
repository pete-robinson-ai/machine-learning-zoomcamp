...
- **[C++](./c++)** — Performance programming basics (learncpp.com)

## Current Focus
- ML Zoomcamp (Month 1)
- SQLBolt (in progress)
- GenAI Projects (planning phase)

**Goal**: Build a strong portfolio for Junior ML / GenAI Engineer roles in the United States.
